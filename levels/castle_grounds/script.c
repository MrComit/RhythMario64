...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_EGADD, -1632, 0, 1266, 0, 90, 0, 0x00010000, bhvEgadd),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -1671, 0, -747, 0, 0, 0, 0x00810000, bhvWarpPipe),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -1671, 0, -145, 0, 0, 0, 0x00820000, bhvWarpPipe),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -1671, 0, 557, 0, 0, 0, 0x00830000, bhvWarpPipe),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -2029, 0, 974, 0, 0, 0, 0x00840000, bhvWarpPipe),
		OBJECT(MODEL_NONE, -2500, 300, 0, 0, 90, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, 90, -2500, 300, 0),
		TERRAIN(castle_grounds_area_1_collision),
		MACRO_OBJECTS(castle_grounds_area_1_macro_objs),
		//STOP_MUSIC(0),
		SET_BACKGROUND_MUSIC(0x00, SEQ_UN_OWEN),
