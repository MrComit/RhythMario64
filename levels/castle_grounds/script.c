...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_CASTLE_GROUNDS_WARP_PIPE, /*pos*/ -2178, 260, 4164, /*angle*/ 0, 180, 0, /*behParam*/ 0x00830000, /*beh*/ bhvWarpPipe),
    WARP_NODE(/*id*/ 0x82, /*destLevel*/ LEVEL_BOB, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    WARP_NODE(/*id*/ 0x83, /*destLevel*/ LEVEL_JRB, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
