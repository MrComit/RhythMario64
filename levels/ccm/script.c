...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, -9136, 3117, 6728, 0, -180, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_BOWLING_BALL, -11793, 2917, 5934, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, -11162, 2917, 1698, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_GHOST_KOOPA, -11879, 2817, 5170, 0, 0, 0, 0x00020000, bhvKoopa),
		OBJECT(MODEL_NONE, -11285, 2817, 6321, 0, 0, 0, 0x00050000, bhvKoopaRaceEndpoint),
		OBJECT(MODEL_LAVA_SPIRE, -8244, 310, 3331, 0, 0, 0, 0x00000000, bhvLavaSpire),
		OBJECT(MODEL_LAVA_SPIRE, -9957, 310, 3331, 0, 0, 0, 0x00010000, bhvLavaSpire),
		...
		OBJECT(MODEL_NONE, -9136, 3117, 6928, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, -180, -9136, 3117, 6928),
