...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, -4401, 3532, -1950, 0, -180, 0, 0x000B0000, bhvAirborneDeathWarp),
		...
		OBJECT(MODEL_NONE, -4401, 3532, -1750, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, -180, -4401, 3532, -1750),
