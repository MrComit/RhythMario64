...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_CASTLE_ROCK, 5399, 2417, -2186, 0, 0, 0, 0x00000000, bhvCastleRock),
		OBJECT(MODEL_CASTLE_ROCK, 5399, 2417, -1142, 0, 0, 0, 0x00010000, bhvCastleRock),
		OBJECT(MODEL_CASTLE_ROCK, 6300, 2417, -2186, 0, 0, 0, 0x00010000, bhvCastleRock),
		OBJECT(MODEL_CASTLE_ROCK, 6300, 2417, -1142, 0, 0, 0, 0x00000000, bhvCastleRock),
