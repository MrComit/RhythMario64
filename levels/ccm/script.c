...
const LevelScript level_ccm_entry[] = {
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_DISCO_BALL, 174, 796, -2066, 0, 0, 0, 0x00000000, bhvDiscoBall),
		OBJECT(MODEL_NONE, -996, 0, -77, 0, 0, 0, 0x00000000, bhvDiscoBillSwitch),
		OBJECT(MODEL_NONE, -216, 0, 462, 0, 0, 0, 0x00000000, bhvDiscoBillSwitch),
		OBJECT(MODEL_NONE, 1196, 0, -31, 0, 0, 0, 0x00000000, bhvDiscoBillSwitch),
		OBJECT(MODEL_DISCO_BALL, -912, 431, -3281, 0, 0, 0, 0x00000000, bhvDiscoLock),
		OBJECT(MODEL_DISCO_BALL, 842, 431, -2814, 0, 0, 0, 0x00000000, bhvDiscoLock),
		OBJECT(MODEL_DISCO_BALL, 2253, 431, -3494, 0, 0, 0, 0x00000000, bhvDiscoLock),
		OBJECT(MODEL_BOWLING_BALL, -2075, 200, 2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 2075, 200, 2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 2075, 200, -2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, -2075, 200, -2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_NONE, 194, 158, -1797, 0, 0, 0, 0x00000000, bhvRotatingSawblade),
