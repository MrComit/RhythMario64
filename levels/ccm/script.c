...
const LevelScript level_ccm_entry[] = {
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_BOSS_ROCK, -1354, -150, 1955, 0, 0, 0, 0x00000000, bhvBossRock),
		OBJECT(MODEL_BOSS_ROCK, -954, -150, 1955, 0, 0, 0, 0x00010000, bhvBossRock),
		OBJECT(MODEL_BOSS_ROCK, -554, -150, 1955, 0, 0, 0, 0x00000000, bhvBossRock),
		OBJECT(MODEL_BOSS_ROCK, -154, -150, 1955, 0, 0, 0, 0x00010000, bhvBossRock),
		...
		OBJECT(MODEL_DISCO_LOCK, -2767, 1500, -4843, 0, 0, 0, 0x00000000, bhvDiscoLock),
		OBJECT(MODEL_DISCO_LOCK, 0, 1500, -4843, 0, 0, 0, 0x00000000, bhvDiscoLock),
		OBJECT(MODEL_DISCO_LOCK, 2767, 1500, -4843, 0, 0, 0, 0x00000000, bhvDiscoLock),
		OBJECT(MODEL_NONE, -996, 0, -77, 0, 0, 0, 0x00020000, bhvDiscoBillSwitch),
		OBJECT(MODEL_NONE, -216, 0, 462, 0, 0, 0, 0x00010000, bhvDiscoBillSwitch),
		OBJECT(MODEL_NONE, 1196, 0, -31, 0, 0, 0, 0x00000000, bhvDiscoBillSwitch),
		OBJECT(MODEL_BOWLING_BALL, -2075, 200, 2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 2075, 200, 2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 2075, 200, -2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, -2075, 200, -2075, 0, 0, 0, 0x00000000, bhvFireSpitter),
