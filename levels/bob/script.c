...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BARRIER, -14835, -4000, -11747, 0, 0, 0, 0x00000000, bhvBarrier),
		OBJECT(MODEL_BARRIER, 8179, -4000, -15585, 0, -90, 0, 0x00010000, bhvBarrier),
		OBJECT(MODEL_BLOCK, -10966, 500, -6666, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10716, 500, -6666, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10466, 500, -6666, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -11599, 500, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -11349, 500, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -11224, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -11099, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10974, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10849, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10724, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10599, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10474, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10349, 1125, -5240, 0, 0, 0, 0x01000000, bhvBlock),
		...
		OBJECT(MODEL_BOUNCE_HILL, -5006, -4000, -21888, 0, 9, 0, 0x01010000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, 9549, -4000, -19083, 0, 9, 0, 0x02010000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, 17966, -4000, 4854, 0, 9, 0, 0x01010000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, 9988, -4000, 14761, 0, 9, 0, 0x00000000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, 1746, -4000, 14060, 0, 9, 0, 0x02010000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, -2814, -4000, 207, 0, 9, 0, 0x01010000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, -12825, -4000, 342, 0, 9, 0, 0x00000000, bhvBounceHill),
		OBJECT(MODEL_BOUNCE_HILL, 1315, -4000, -20849, 0, 9, 0, 0x00000000, bhvBounceHill),
		...
		OBJECT(MODEL_LAUNCHER, -13750, 250, -5250, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 652, 5641, 0, -90, 0, 0x01000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -5750, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -6250, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -6750, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 652, 5891, 0, -90, 0, 0x01000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 652, 6141, 0, -90, 0, 0x01000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 2006, 7121, 0, -90, 0, 0x02000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 2006, 7371, 0, -90, 0, 0x02000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 2006, 7621, 0, -90, 0, 0x02000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, 8894, 2006, 7871, 0, -90, 0, 0x02000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -5214, 123, -15361, 0, 20, 0, 0x00000000, bhvLauncherRotate),
		OBJECT(MODEL_LAUNCHER, 9915, 454, -8295, 0, -90, 0, 0x00000000, bhvLauncherRotate),
		OBJECT(MODEL_NONE, 5496, 2111, 7594, 0, 0, 0, 0x00320000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 5496, 2626, 7594, 0, 0, 0, 0x00010000, bhvHitboxObjective),
		OBJECT(MODEL_BLOCK, -11696, 500, -6460, 0, 0, 0, 0x01010000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10841, 500, -6666, 0, 0, 0, 0x01010000, bhvBlock),
		OBJECT(MODEL_BLOCK, -10591, 500, -6666, 0, 0, 0, 0x01010000, bhvBlock),
		OBJECT(MODEL_BLOCK, -11474, 500, -5240, 0, 0, 0, 0x01010000, bhvBlock),
		...
		OBJECT(MODEL_RED_COIN, 5882, 700, -12102, 0, 0, 0, 0x01000000, bhvRedCoin),
		...
		OBJECT(MODEL_NONE, -7000, 0, -6000, 0, 90, 0, 0x000B0000, bhvFlyingWarp),
		OBJECT(MODEL_NONE, 5500, 500, 5361, 0, 90, 0, 0x000C0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_NONE, -7686, 0, -6000, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 4469, 500, -6250, 0, -180, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 6500, 500, -6250, 0, -180, 0, 0x00000000, bhvCoinFormation),
