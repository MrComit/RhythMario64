...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_LAUNCHER, -13750, 250, -5500, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -5750, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -6000, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -6250, 0, 90, 0, 0x00000000, bhvLauncher),
		OBJECT(MODEL_LAUNCHER, -13750, 250, -6500, 0, 90, 0, 0x00000000, bhvLauncher),
		...
		OBJECT(MODEL_RED_COIN, 5882, 500, -12102, 0, 0, 0, 0x01000000, bhvRedCoin),
