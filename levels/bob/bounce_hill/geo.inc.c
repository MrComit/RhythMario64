...
const GeoLayout bounce_hill_geo[] = {
	...
	GEO_OPEN_NODE(),
		GEO_NODE_START(),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, bounce_hill_dl2_mesh_layer_6),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, bounce_hill_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
