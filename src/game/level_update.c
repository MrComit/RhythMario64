...
const char *credits07[] = { "@                          SPECIAL THANKS", "", "TECHNOMANCER00", "BANGIN TUNES", "MATT", "BUPENSIVE AND LAVA", "SPK", "VOICES", "MRPR1993", "E.GADD MODEL", "WISEGUY", "LASER RINGS", "AGLAB2", "INSPIRATION", "JANJA", "END SCREEN"};
