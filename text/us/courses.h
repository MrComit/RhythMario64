COURSE_ACTS(COURSE_BOB, _(" 1 BARITONE BATTLEFIELD"),
...
COURSE_ACTS(COURSE_WF, _(" 2 SUBMARINE SEA MAJOR"),
...
COURSE_ACTS(COURSE_JRB, _(" 2 SUBMARINE SEA MAJOR"),
...
COURSE_ACTS(COURSE_CCM, _(" 3 TREBLE CLEF CASTLE"),
